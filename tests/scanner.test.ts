...
import { auditAgentCard } from '../src/core/scanner';
import { formatSarifReport } from '../src/formatters/sarif';
import { formatTerminalReport } from '../src/formatters/terminal';
...
async function runTests() {
  ...
  const ruleNames = vulnerableReport.findings.map(f => f.ruleName);
